...
var style_loc4300100010_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_loc4300100010_1_eval_expression(context) !== null) {
        labelText = String(exp_label_loc4300100010_1_eval_expression(context));
    }
